    ...
    return (
        <form method="POST" className="container forms shadow mt-3 form">
            ...
            <div className="mb-3">
                ...
                <input type="text" className="form-control" id="endereco" name="endereco" placeholder="insira o endereço" />
            </div>
            <div className="mb-3">
                <label htmlFor="cidade" className="form-label">Cidade</label>
                <input type="text" className="form-control" id="cidade" name="cidade" placeholder="insira a cidade" />
            </div>
            <div className="mb-3">
                <label htmlFor="estado" className="form-label">Estado</label>
                <input type="text" className="form-control" id="estado" name="estado" placeholder="insira o estado" />
            </div>
            <div className="mb-3">
                <label htmlFor="credenciamento" className="form-label">Credenciamento</label>
                <input type="text" className="form-control" id="credenciamento" name="credenciamento" placeholder="insira o credenciamento" />
            </div>
            <div className="mb-3">
