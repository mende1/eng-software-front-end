        ...
        <form method="POST" className="container forms shadow mt-3 form">
            ...
            <div className="mb-3">
                ...
                <select onChange={handleChange} className="form-select" aria-label="Tipo de Usuário" id="user-type" name="user-type" value={tipo}>
                    ...
                    {/* Se for Instituição Validadora */}
                    <option value="3">Diretor</option>

                    {/* Se for Instituição Não Validadora */}
                    <option value="4">Superitendente</option>
                    <option value="5">Coordenador CARE</option>
                </select>
            </div>
            <div className="mb-3">
            ...
            <div className="mb-3">
                ...
                <input type="email" className="form-control" id="email" placeholder="exemplo@email.com" name="email" />

            </div>
            <div className="mb-3">
                <label htmlFor="password" className="form-label">Senha</label>
                <input type="password" className="form-control" id="password" placeholder="digite sua senha" name="password" />
            </div>

            <div className="mb-3">
                <label htmlFor="telefone" className="form-label">Telefone</label>
                <input type="text" className="form-control" id="telefone" name="telefone" placeholder="insira o telefone" />
            </div>
            <div className="mb-3">
